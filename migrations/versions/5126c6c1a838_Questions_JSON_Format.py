...
def upgrade():
    ...
    op.alter_column('ecoe', 'status',
                    existing_type=mysql.ENUM('ARCHIVED', 'DRAFT', 'PUBLISHED'),
                    nullable=False)
...
def downgrade():
    ...
    op.add_column('question', sa.Column('question_type', mysql.ENUM('RADIO_BUTTON', 'CHECK_BOX', 'RANGE_SELECT'), nullable=False))
    ...
    option = op.create_table('option',
                             ...
                             sa.Column('label', mysql.VARCHAR(length=255),
                                       nullable=True),
    ...
    question = table(
        ...
        sa.Column('question_type',
                  mysql.ENUM('RADIO_BUTTON', 'CHECK_BOX', 'RANGE_SELECT'),
                  nullable=False),
        sa.Column('question_schema', mysql.LONGTEXT()),
        # Other columns not needed for the data migration
    )
